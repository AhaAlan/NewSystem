...
<@override name="content">
				...
				<form class="ui large form" id="form">
					<table class="ui table celled striped  striped ">
						...
						<tr>
							...
							<td class="center aligned">
								<div class="field disabled">
									<input type="text" name="id" value="${admin.id!''}" placeholder="${admin.id!''}">
								</div>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="center aligned">
								<div class="field ">
									<input type="text" name="tel" value="${admin.tel!''}" placeholder="${admin.tel!''}">
								</div>
							</td>
						</tr>
						<tr>
							...
							<td class="center aligned">
								<div class="field ">
									<input type="text" name="email" value="${admin.email!''}" placeholder="${admin.email!''}">
								</div>
							</td>
						</tr>
						<tr>
							...
							<td class="center aligned">
								<div class="field ">
									<select class="ui dropdown" name="super" value="${admin.super!''}">
										<option value="${admin.super!''}">选择类型</option>
	...
	<script>
        ...
        $('.ui.form').form({
            ...
            method: 'POST',
            url: '${base}/admin/DomodifiyAdminInfo',
            serializeForm: true,
